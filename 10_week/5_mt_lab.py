...
load_dotenv() # fulfill .env with data from LangSmith (2)

# pip install -U langsmith (1)
...
# Добавляем root run и создаём точку входа (3)

from langsmith import traceable

@traceable(name="mt_answer_question")
def answer_question(question: str, context: str) -> str:
    ...
    return rag_lab_chain.invoke(inputs)
...
if __name__ == "__main__":
    ...
    questions = [
        "Что такое MT-LAB?",
        "Какую мебель продают в MT-LAB?",
        "Cпособы связи с MT-LAB?",
    ]
